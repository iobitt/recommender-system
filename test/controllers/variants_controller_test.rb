...
class VariantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create variant" do
    assert_difference("Variant.count") do
      post variants_url, params: { variant: { account_id: @variant.account_id, product_id: @variant.product_id, title: @variant.title } }
    end
  ...
  test "should update variant" do
    patch variant_url(@variant), params: { variant: { account_id: @variant.account_id, product_id: @variant.product_id, title: @variant.title } }
