...
class OrderLinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_line" do
    assert_difference("OrderLine.count") do
      post order_lines_url, params: { order_line: { account_id: @order_line.account_id, order_id: @order_line.order_id, product_id: @order_line.product_id, quantity: @order_line.quantity, title: @order_line.title, variant_id: @order_line.variant_id } }
    end
  ...
  test "should update order_line" do
    patch order_line_url(@order_line), params: { order_line: { account_id: @order_line.account_id, order_id: @order_line.order_id, product_id: @order_line.product_id, quantity: @order_line.quantity, title: @order_line.title, variant_id: @order_line.variant_id } }
